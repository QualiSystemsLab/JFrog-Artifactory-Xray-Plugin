...
from sandbox_scripts.helpers.artifactory_helper import artifactory_helper
...
class EnvironmentSetup(object):
    ...
    def execute(self):
        ...
        try:
            ...
            api.WriteMessageToReservationOutput(reservationId=self.reservation_id, message="Error in Artifactory. {}".format(str(e)))
